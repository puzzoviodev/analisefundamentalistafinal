...
def coletar_resultados_avaliacao():
    ...
    testes_lucro = [
        ...
        (5, "Moderado"),  # 5% < Margem Líquida <= 10%
        (10, "Bom"),  # 10% < Margem Líquida <= 20%
    ...
    testes_ebitda = [
        ...
        (10, "Moderado"),  # 10% < Margem EBITDA <= 20%
        (20, "Bom"),  # 20% < Margem EBITDA <= 30%
    ...
    for DivLiquidaEBITDA, condicao in testes_DivLiquidaEBITDA:
        ...
        adicionar_resultado(resultado, "DivLiquidaEBITDAEvaluator", f"avaliar (lucro={DivLiquidaEBITDA})")

    # 17. Testes para DivLiquidaEBITEvaluator
    ...
    for DivLiquidaEBIT, condicao in testes_DivLiquidaEBIT:
        ...
        adicionar_resultado(resultado, "DivLiquidaEBIT", f"avaliar (lucro={DivLiquidaEBIT})")
    ...
    for PLAtivos, condicao in testes_PLAtivos:
        ...
        adicionar_resultado(resultado, "PLAtivos", f"avaliar (lucro={PLAtivos})")
    ...
    for DividendYield, condicao in testes_DividendYieldEvaluator:
        ...
        adicionar_resultado(resultado, "DividendYieldEvaluator", f"avaliar (lucro={DividendYield})")
    ...
    testes_LiquidezCorrenteEvaluator = [
        ...
        (0.8, "Moderado"),  # '0.8 <= Liquidez Corrente < 1.2',
    ...
    for LiquidezCorrente, condicao in testes_LiquidezCorrenteEvaluator:
        ...
        adicionar_resultado(resultado, "LiquidezCorrenteEvaluator", f"avaliar (lucro={LiquidezCorrente})")

    # 21. Testes para PatrimonioLiquidoEvaluator
    ...
    for PatrimonioLiquido, condicao in testes_PatrimonioLiquidoEvaluator:
        ...
        adicionar_resultado(resultado, "PatrimonioLiquidoEvaluator", f"avaliar (lucro={PatrimonioLiquido})")

    # 22. Testes para EVEBITDAEvaluator
    ...
    for EVEBITDAE, condicao in testes_EVEBITDAEvaluator:
        ...
        adicionar_resultado(resultado, "EVEBITDAEvaluator", f"avaliar (lucro={EVEBITDAE})")
    ...
    for EVEBITE, condicao in testes_EVEBITEvaluator:
        ...
        adicionar_resultado(resultado, "EVEBITEvaluator", f"avaliar (lucro={EVEBITE})")
    ...
    for PEBITDA, condicao in testes_PEBITDAEvaluator:
        ...
        adicionar_resultado(resultado, "PEBITDAEvaluator", f"avaliar (lucro={PEBITDA})")

    # 25. Testes para PEBITEvaluator
    ...
    for PAtivo, condicao in testes_PAtivovaluator:
        ...
        adicionar_resultado(resultado, "PAtivoEvaluator", f"avaliar (lucro={PAtivo})")

    # 27. Testes para LPAEvaluator
    ...
    for LPA, condicao in testes_LPAEvaluator:
        ...
        adicionar_resultado(resultado, "LPAEvaluator", f"avaliar (lucro={LPA})")
